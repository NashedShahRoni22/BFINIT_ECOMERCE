...
import { ecommerceTips } from "@/utils/contstants";
          ...
          >
            ...
            <ChevronDown
              ...
              className={`transition-transform duration-200 ease-linear ${
                show.id === index && show.state && "rotate-180"
              }`}
            />
          </button>

          <div
            className={`grid overflow-hidden opacity-100 transition-all duration-200 ease-linear ${
