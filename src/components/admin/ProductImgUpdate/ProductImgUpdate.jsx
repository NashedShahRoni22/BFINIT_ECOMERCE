...
export default function ProductImgUpdate({
  selectedImages,
  setSelectedImages,
  imagePreviews,
  setImagePreviews,
  ...
  // Delete image
  const handleImageRemove = (index, preview) => {
  ...
  // Delete device upload selected file
  const deleteSelctedImg = (index) => {
    setSelectedImages((prevImages) => prevImages.filter((_, i) => i !== index));
  };
