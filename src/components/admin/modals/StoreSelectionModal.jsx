    ...
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      <DialogContent className="w-[calc(100%-2rem)] max-w-[400px] gap-0 p-0 sm:w-full [&>button]:hidden">
        ...
        <div className="border-t px-3 py-3 sm:py-2.5">
          <Link
            to="/stores/create"
            className="text-foreground hover:bg-accent focus-visible:bg-accent active:bg-accent flex w-full touch-manipulation items-center justify-center gap-1.5 rounded-md px-2.5 py-2 text-sm font-medium transition-colors focus-visible:outline-none sm:py-1.5 sm:text-xs"
          >
