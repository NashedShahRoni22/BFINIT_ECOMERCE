...
function FieldSet({ className, ...props }) {
  return (
    <fieldset
      data-slot="field-set"
      className={cn(
        "bg-card flex flex-col gap-0 rounded-lg border",
...
function FieldGroup({ className, ...props }) {
  return (
    <div
      ...
      className={cn(
        "group/field-group @container/field-group grid w-full grid-cols-2 gap-x-4 gap-y-5 px-5 py-4 data-[slot=checkbox-group]:gap-3 [&>[data-slot=field-group]]:gap-4",
        className,
      )}
      {...props}
    />
...
function FieldError({ className, children, errors, ...props }) {
  ...
  return (
    <div
      ...
      className={cn("text-destructive -mt-1 text-xs font-normal", className)}
      {...props}
    >
      {content}
    </div>
